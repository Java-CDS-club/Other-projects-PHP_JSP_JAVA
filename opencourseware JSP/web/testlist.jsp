...
Class.forName("com.mysql.jdbc.Driver");
    ...
    Statement stm = con.createStatement();
       ...
       ResultSet rst=stm.executeQuery("select * from course order by stream asc,semester asc");


          out.println("<table border='1' align='center' cellpadding='1' bordercolor='#000000' bgcolor='#9999FF' id='table1'><tr bgcolor='#9966FF'><th>Id</th><th>Stream</th><th>sub</th><th>Test</th></tr>");
