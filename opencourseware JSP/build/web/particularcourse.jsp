...
Class.forName("com.mysql.jdbc.Driver");
    ...
    Statement stm = con.createStatement();
       ...
       ResultSet rst=stm.executeQuery("select * from course where stream='"+stream+"' and approved='yes' and semester='"+subject+"' order by stream asc");
       int counttr=0;

          //out.println("<table border='1' width='1200px' align='center' cellpadding='1' bordercolor='#000000' bgcolor='#FFFFCC' id='table1'><tr bgcolor='#9966FF'><th>Id</th><th>Stream</th><th>Subject</th><th>Topic</th><th>type</th></tr>");
          out.println("<table width='' border='0' cellpadding='50' cellspacing='90'>");
          while(rst.next())
            {
              String topicdesc=rst.getString("subject");
            ...
            {
            out.println("<div id=type><a href='"+link+"'><img src=images/txt.jpg height=40 width=40 /></a></div>");
            }
            else if(type.equals("text/html"))
               {
            out.println("<div id=type><a href='"+link+"'><img src=images/html.jpg height=40 width=40 /></a></div>");
               }
            else if(type.equals("application/pdf"))
                {
             out.println("<div id=type><a href='"+link+"'><img src=images/pdf.jpg height=40 width=40 /></a></div>");
                }
            else if(type.equals("image/jpeg"))
                {
             out.println("<div id=type><a href='"+link+"'><img src=images/other.jpg height=40 width=40 /></a></div>");
                }
            else
                {
               out.println("<div id=type><a href='"+link+"'><img src=images/other2.jpg height=40 width=40 /></a></div>");
                }
           
            out.println("<div id=subject><font color=white size=5>"+subject+"</font></div>");
            out.println("<div id=topicdesc><font color=white size=3><a href='"+link+"'>"+topicdesc+"</a></font></div>");
